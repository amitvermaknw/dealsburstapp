...
const SignupWithGoogleDialog = ({ onCancel }: Props) => {
    // const [loader, setLoader] = useState(false)
    // const onCancel = () => {

    // }

    return (<Modal title="Please sign-up" onClick={onCancel}>
...
export default SignupWithGoogleDialog;