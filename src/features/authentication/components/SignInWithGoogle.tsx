    ...
    return (
        <div className="px-6 py-4">
            ...
            >
                ...
                {isLoading ? <><svg aria-hidden="true" role="status" className="inline ml-14 w-4 h-4 me-3 text-white animate-spin" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                </svg>Loading...</> : <span>Continue with Google</span>}
            </button>
        </div>
    );
};
