...
const SearchWidget = () => {
    ...
    return (<>
        <div className="grid gap-4 grid-cols-1 m-2" onClick={() => setSearchModal(true)}>
            <div className="bg-white dark:bg-slate-900 relative pointer-events-auto">
                <button type="button" className="w-full flex items-center text-sm leading-6 text-slate-400 rounded-md ring-1 ring-slate-900/10 shadow-sm py-1.5 pl-2 pr-3 hover:ring-slate-300 dark:bg-slate-800 dark:highlight-white/5 dark:hover:bg-slate-700">
